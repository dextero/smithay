...
impl VulkanImport {
    ...
    pub unsafe fn import_dmabuf(
        ...
        let vk_format = match format.code {
            smithay::backend::allocator::Fourcc::Argb8888 => vk::Format::B8G8R8A8_UNORM,
            smithay::backend::allocator::Fourcc::Xrgb8888 => vk::Format::B8G8R8A8_UNORM,
            smithay::backend::allocator::Fourcc::Abgr8888 => vk::Format::R8G8B8A8_UNORM,
            smithay::backend::allocator::Fourcc::Xbgr8888 => vk::Format::R8G8B8A8_UNORM,
        ...
        let memory_type_index = 0; // TODO: proper selection
